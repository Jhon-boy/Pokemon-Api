        ...
        <div className='contactoForm'>
            <div className="container-form">
                <div className="info-form">
                    ...
                    <a href="#httphone" value='e'><i className="fa fa-phone"></i><BsPhoneVibrate style={{ color: 'black', fontSize: '35px', marginRight: '20px' }} /> +1 (593) 333-9649</a>
                    <a href="htts"><i className="fa fa-envelope"></i> <BsEnvelopeAt style={{ color: 'black', fontSize: '35px' , marginRight: '20px' }} /> jhoncuvi12@gmail.com</a>
                ...
                <form action="#" autoComplete="off">
                 ...
                 <center>
                    ...
                    <input name="enviar" value="Volver" className="btn-volver"  onClick={() => navigateTo('/')}/>
                 </center>   
                </form>
            </div>
